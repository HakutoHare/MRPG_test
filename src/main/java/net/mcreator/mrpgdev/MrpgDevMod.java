...
@Mod("mrpg_dev")
public class MrpgDevMod {
	public static final Logger LOGGER = LogManager.getLogger(MrpgDevMod.class);
	public static final String MODID = "mrpg_dev";
